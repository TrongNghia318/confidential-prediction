  ...
  useEffect(() => {
    const checkNetwork = async () => {
      ...
      try {
        ...
        setIsWrongNetwork(currentChainId !== CHAIN_ID);
      } catch (error) {
        ...
        <div className="text-center">
          ...
          <div className="bg-purple-50 rounded-lg p-4 mb-6 text-left">
            ...
            <div className="ml-4 space-y-1 text-sm text-gray-600">
              ...
              <div>
                <span className="font-medium">Chain ID:</span> {CHAIN_ID}
              </div>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full gradient-purple text-white px-6 py-3 rounded-lg hover:opacity-90 transition font-medium disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSwitching ? (
